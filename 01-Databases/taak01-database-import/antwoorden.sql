127.0.0.1/modmysql_basic_imdb_movies./movies/		http://localhost/phpmyadmin/db_sql.php?db=+modmysql_basic_imdb_movies.
 Weergave van records 0 - 24 (98 totaal, Query duurde 0,0037 seconden.)
